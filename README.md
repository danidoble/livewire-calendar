...
If you want to render a heading with the month and year, you can use the `default-heading` prop.
...
(This options should be used through using blade views based on the component default views)
...
- `calendar-view` which can be any `blade.php` view that renders the whole component. It's advised to override this
  view with an altered copy of the base `calendar-view` e.g. adding a view next to the component.
...
- [Andrés Santibáñez](https://github.com/asantibanez) for the original package
- [Dani Doble](https://github.com/danidoble)
